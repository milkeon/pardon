...
const TRAINING_SAMPLES = [
  ...
  { label: 'summary', text: '요약하면, AI가 상황을 이해하고 데이터가 부족하면 결과가 흔들립니다.' },
  { label: 'summary', text: '핵심은 문맥을 보고 필요한 정보를 정리해 주는 것입니다.' },
  { label: 'summary', text: '정리하면, 여러 표현을 하나의 흐름으로 묶어서 읽히게 만들어야 합니다.' },
  { label: 'summary', text: '긴 설명은 핵심 원인과 결과만 남겨서 정리해야 합니다.' },
